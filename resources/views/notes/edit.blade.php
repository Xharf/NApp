        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 ">
                <form action="{{ route('notes.update', $note->id) }}" class="my-5" method="POST">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control border-0" placeholder="Tag " value="{{old('tags',  $note->tags)}}"
                            name="tags" />
                    </div>

                    <div class="mb-5">
                        <input id="body" type="hidden" name="body" value="{{ old('body',$note->body) }}"required>
                        <trix-editor input="body" class="border-0" placeholder="+ Tambahkan catatan yang muantap..."></trix-editor>
                    </div>
